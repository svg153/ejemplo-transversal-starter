...
type VersionResponse = { // Define the stable response contract explicitly.
...
const versionResponse: Readonly<VersionResponse> = { // Build a stable response payload once.
...
versionRouter.get(`${config.apiBasePath}/version`, (_request, response) => { // Expose the version endpoint under the API base path.
