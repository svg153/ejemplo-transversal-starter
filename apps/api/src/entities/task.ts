...
export interface TaskEntity {
  // Define the persisted shape for backend tasks.
...
export const TaskEntitySchema = new EntitySchema<TaskEntity>({
  // Register the task table schema for TypeORM.
  ...
  columns: {
    ...
    userId: {
      // Configure the owning user foreign key column.
  ...
  relations: {
    // Describe the explicit relation to users.
    user: {
      // Configure the owning user relation.
