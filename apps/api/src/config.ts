...
const DEFAULT_DATABASE_URL =
  "postgresql://postgres:postgres@localhost:5432/task_tracker"; // Mirror the documented local PostgreSQL connection string.
...
export const config = {
  ...
  database: {
    // Group database settings under one explicit namespace.
